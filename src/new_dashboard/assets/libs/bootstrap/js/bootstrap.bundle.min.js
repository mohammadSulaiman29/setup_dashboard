...
! function(t, e) {
    ...
    const Fi = new Set(["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"]),
        ...
        Xi = {
            Entry_Bill: "(string|element|function|null)",
    ...
    class mn extends z {
        ...
        _observerCallback(t) {
            const e = t => this._targetLinks.get(`#${t.target.id}`),
                i = t => {
                    this._previousScrollData.visibleEntry_BillTop = t.target.offsetTop, this._process(e(t))
                },
            ...
            for (const o of t) {
                ...
                const t = o.target.offsetTop >= this._previousScrollData.visibleEntry_BillTop;
                if (s && t) {
                    if (i(o), !n) return
                } else s || t || i(o)
            }
